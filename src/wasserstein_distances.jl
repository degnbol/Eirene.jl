...
# main function is 'wasserstein_distance'
...
function dist_mat(v1, v2; p=2)
    #=  Accepts two equal size vectors and their original lengths and 
    #finite values.Returns the minimal Lp distance of their persistence 
    #diagrams.  =#
